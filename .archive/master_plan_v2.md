...
- Detailed Phase 0 step-by-step plan:
  ...
  11. Add foundational app behavior required by later phases: request IDs, shared error-shape helpers, explicit body-size limits, strict CORS allowlist wiring, and startup defaults for `0.0.0.0:$PORT`.
